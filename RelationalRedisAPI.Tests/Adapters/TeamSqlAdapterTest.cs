...
{
    [TestClass]
    public class TeamSqlAdapterTest
    {
        ...
        private TeamSqlAdapter Adapter;

        [TestInitialize]
        public void SetUp()
        {
            var powerAdapter = new PowerSqlAdapter(ConnectionString);
            var heroAdapter = new HeroSqlAdapter(ConnectionString, powerAdapter);
            Adapter = new TeamSqlAdapter(ConnectionString, heroAdapter);
        }
        ...
        {
            // Arrange
            var numPreExistingTeams = AdapterTestHelpers.CountSqlTeams(ConnectionString);
            ...
            // Assert
            var numPostExistingTeams = AdapterTestHelpers.CountSqlTeams(ConnectionString);
        ...
        public void Delete_ExistingTeam_RemovesOneRecord()
        {
            ...
            // Assert
            var numPostExistingPowers = AdapterTestHelpers.CountSqlTeams(ConnectionString);
